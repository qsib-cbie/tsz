...
///
/// Construct a unsigned from a Uvlq.
///
/// Fails if the Uvlq is longer than the bit width of the output type.
///
macro_rules! impl_unsigned_try_from_uvlq {
    ($unsigned:ident) => {
...
impl_unsigned_try_from_uvlq!(u8);
impl_unsigned_try_from_uvlq!(u16);
impl_unsigned_try_from_uvlq!(u32);
impl_unsigned_try_from_uvlq!(u64);

#[cfg(test)]
mod tests {
    #[test]
    fn can_encode_0() {
        let uvlq = super::Uvlq::from(0);
    ...
    #[test]
    fn can_encode_33333() {
        let uvlq = super::Uvlq::from(33333);
